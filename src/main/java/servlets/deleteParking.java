...
public class deleteParking extends HttpServlet {
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement statementDeletePlazas = con.prepareStatement(sqlDeletePlazas);
            ...
            PreparedStatement statementDeleteParking = con.prepareStatement(sqlDeleteParking);
